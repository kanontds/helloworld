(ns clotest.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [clotest.routes.home :refer [home-routes]]
            [clotest.middleware :as middleware]
            [clotest.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "clotest is shutting down...")
  (stop-nrepl)
